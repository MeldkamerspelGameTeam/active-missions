...
| Missions seen in last 30 days | 1574 |

### Never-Seen Breakdown

| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 892 |
| Never seen active missions | 691 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 174 |
| Old seen active missions | 122 |
...
pie showData
    ...
    "Seen last 30 days" : 1560
    "Never seen" : 691
    "Old seen 30+ days" : 122
```
...
pie showData
    ...
    "Active — seen last 30 days" : 1560
    "Active — never seen" : 691
    "Active — old seen 30+ days" : 122
