...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 866 |
| Never seen active missions | 658 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 143 |
| Old seen active missions | 106 |
...
pie showData
    ...
    "Active — never seen" : 658
    "Active — old seen 30+ days" : 106
