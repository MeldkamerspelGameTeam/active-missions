...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 564 |
| Never seen active missions | 354 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 1 |
| Old seen active missions | 1 |
...
pie showData
    ...
    "Active — seen last 30 days" : 1334
    "Active — never seen" : 354
    "Active — old seen 30+ days" : 1
    "Inactive — seen last 30 days" : 52
