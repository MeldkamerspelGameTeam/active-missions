...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 888 |
| Never seen active missions | 678 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 121 |
| Old seen active missions | 84 |
...
pie showData
    ...
    "Active — never seen" : 678
    "Active — old seen 30+ days" : 84
