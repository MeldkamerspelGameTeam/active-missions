...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 901 |
| Never seen active missions | 700 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 173 |
| Old seen active missions | 121 |
...
pie showData
    ...
    "Seen last 30 days" : 1552
    "Never seen" : 700
    "Old seen 30+ days" : 121
```
...
pie showData
    ...
    "Active — seen last 30 days" : 1552
    "Active — never seen" : 700
    "Active — old seen 30+ days" : 121
