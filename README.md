...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 940 |
| Never seen active missions | 730 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 75 |
| Old seen active missions | 38 |
...
pie showData
    ...
    "Active — never seen" : 730
    "Active — old seen 30+ days" : 38
