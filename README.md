...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 906 |
| Never seen active missions | 696 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 98 |
| Old seen active missions | 61 |
...
pie showData
    ...
    "Active — never seen" : 696
    "Active — old seen 30+ days" : 61
