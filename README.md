...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 942 |
| Never seen active missions | 732 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 69 |
| Old seen active missions | 32 |
...
pie showData
    ...
    "Active — never seen" : 732
    "Active — old seen 30+ days" : 32
