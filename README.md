...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 891 |
| Never seen active missions | 681 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 115 |
| Old seen active missions | 78 |
...
pie showData
    ...
    "Active — never seen" : 681
    "Active — old seen 30+ days" : 78
