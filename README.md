...
| Missions seen in last 30 days | 1535 |

### Never-Seen Breakdown

| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 938 |
| Never seen active missions | 728 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 83 |
| Old seen active missions | 46 |
...
pie showData
    ...
    "Active — never seen" : 728
    "Active — old seen 30+ days" : 46
