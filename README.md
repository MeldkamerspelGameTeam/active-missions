...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 887 |
| Never seen active missions | 677 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 122 |
| Old seen active missions | 85 |
...
pie showData
    ...
    "Active — never seen" : 677
    "Active — old seen 30+ days" : 85
