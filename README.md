...
| Missions seen in last 30 days | 1461 |

### Never-Seen Breakdown

| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 1072 |
| Never seen active missions | 862 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 19 |
| Old seen active missions | 13 |
| Old seen inactive missions | 6 |
...
pie showData
    ...
    "Active — seen last 30 days" : 1415
    "Active — never seen" : 862
    "Active — old seen 30+ days" : 13
    "Inactive — seen last 30 days" : 46
    "Inactive — never seen" : 210
    "Inactive — old seen 30+ days" : 6
```
