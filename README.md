...
| Missions seen in last 30 days | 1549 |

### Never-Seen Breakdown

| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 872 |
| Never seen active missions | 664 |
| Never seen inactive missions | 208 |

### Old-Seen Breakdown (30+ days)

| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 137 |
| Old seen active missions | 100 |
...
pie showData
    ...
    "Active — never seen" : 664
    "Active — old seen 30+ days" : 100
    "Inactive — seen last 30 days" : 31
    "Inactive — never seen" : 208
