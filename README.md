...
| Missions seen in last 30 days | 1565 |

### Never-Seen Breakdown

| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 852 |
| Never seen active missions | 652 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 141 |
| Old seen active missions | 104 |
...
pie showData
    ...
    "Seen last 30 days" : 1536
    "Never seen" : 652
    "Old seen 30+ days" : 104
```
...
pie showData
    ...
    "Active — seen last 30 days" : 1536
    "Active — never seen" : 652
    "Active — old seen 30+ days" : 104
