...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 897 |
| Never seen active missions | 687 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 111 |
| Old seen active missions | 74 |
...
pie showData
    ...
    "Active — never seen" : 687
    "Active — old seen 30+ days" : 74
