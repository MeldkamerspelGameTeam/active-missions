...
| Metric | Value |
| --- | ---: |
| Never seen missions (total) | 932 |
| Never seen active missions | 722 |
...
| Metric | Value |
| --- | ---: |
| Old seen missions (older than 30 days) | 86 |
| Old seen active missions | 49 |
...
pie showData
    ...
    "Active — never seen" : 722
    "Active — old seen 30+ days" : 49
